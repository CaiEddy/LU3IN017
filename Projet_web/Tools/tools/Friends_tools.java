...
public class Friends_tools {
	...
	public static boolean exists_friend(String id1,String id2) throws Exception {
		ArrayList<String>res = Mini_tools.requeteGET("Select * From "+table+" Where id1="+id1+" AND id2='"+id2+"' ;");
	...
	public static boolean creation_friend(String id1, String id2) throws Exception {
		return Mini_tools.requeteSET("INSERT INTO `"+table+"` (`id1`, `id2`, `date`, `nb_ami_commun`) "
								+ "VALUES ("+id1+","+id2+", CURRENT_DATE(), '1');");
	}
	...
	public static boolean mise_a_jour_nb_ami_commun(String id1, String id2) throws Exception {
        ...
        return Mini_tools.requeteSET("UPDATE "+table+" SET nb_ami_commun="+nb_commun+" Where (id1='"+id1+"' AND id2='"+id2+"' )"
